...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('Plants', [
      ...
      { name: 'Christmas Cactus', scientificName: 'Schlumbergera truncata', imgUrl: '../../public/images/plants/plant-img005' },
      { name: 'Moth Orchid', scientificName: 'Phalaenopsis', imgUrl: '../../public/images/plants/plant-img006' },
      { name: 'ZZ Plant', scientificName: 'Zamioculcas zamiifolia', imgUrl: '../../public/images/plants/plant-img007' },
      { name: 'Ceriman', scientificName: 'Monstera deliciosa', imgUrl: '../../public/images/plants/plant-img008' },
      { name: 'Ponytail Palm', scientificName: 'Beaucarnea recurvata', imgUrl: '../../public/images/plants/plant-img009' },
